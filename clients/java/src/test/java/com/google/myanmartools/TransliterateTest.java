...
{  // #96
  ...
  {  // # 97
    "ဆိုေတး အေ၀းေရာက္ခ်စ္သူ",
     "ဆိုတေး အဝေးရောက်ချစ်သူ"
  },
  { // From case 41:  #98
    "myanmar ေငြေစ်း",
        "myanmar ငွေဈေး"
  ...
  {  // From case 122.  #99
    "l ဆိုင္းဇီ ေ၀ခြဲမရပါလား",
        "l ဆိုင်းဇီ ဝေခွဲမရပါလား"
        },
    {  // #100 From case #211
      "ေ၀သစ္လြင္ about",
          "ဝေသစ်လွင် about"
  ...
  { // #107 From case 45: Digit found C++
     "၀ိုင္း၀ိုင္း သီခ်င္းမ်ား",
     "ဝိုင်းဝိုင်း သီချင်းများ"
  },
...
private final String[][] normalizeTestCases = {
   ...
   */
  public void z2UCompatibilityTest() throws IOException {
    ...
    while (zLine != null) {
      ...
      assertWithMessage("Difference in line " + lineNum).
   ...
   */
  public void u2ZCompatibilityTest() throws IOException {
