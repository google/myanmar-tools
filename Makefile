...
copy-resources:
	...
	cp data/src/main/resources/zawgyiUnicodeModel.dat clients/ruby/lib/myanmar-tools/resources
	...
	cp data/src/main/resources/compatibility.tsv clients/ruby/lib/myanmar-tools/resources
